...
keywords:
  ...
  - data analysis
  - scientific writing
edit_url: https://github.com/veillette/hands-on/blob/main/content/Chapter7.md
---
+++
...
```{image} ../figures/ch7/free_fall_apparatus.png
:alt: A completed free-fall apparatus diagram.
```
...
```{image} ../figures/ch7/Fig7_2.png
:alt: A completed graph.
```
