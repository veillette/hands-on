...
#image("files/Fig4_1-c573f0d2ee7b603bcb762f69aa1b0fad.png", width: 90%)
...
#image("files/Fig4_2-8bd2090ef20507ae7fccf5f5b3aa095a.png", width: 90%)
...
#image("files/Fig4_3-cd5b0865793ac23ea22c5992be76e587.png", width: 90%)
...
#image("files/Fig4_4-adcf672d10825c3dad2473a036a23a3b.png", width: 90%)

#image("files/Fig4_5-ffe5c94802d01c1f9b9fc74c22802cdb.png", width: 90%)
...
#image("files/Fig4_6-0e4580f9df144e7e1b1ab28a78007e55.png", width: 90%)
...
#image("files/Fig4_7-df616475481afe4fef6e0f6139db05ee.png", width: 90%)
...
#image("files/Fig4_8-714894f552cf32c87f7b5b5cb7123f15.png", width: 90%)
...
$ v = 9. 8 t "(assuming"v = 0 "at"t = 0 ")" $
And:

$ x = frac(9. 8, 2) t^2 "(assuming"x = 0 "at"t = 0 ")" $
Rearranging to express time as a function of distance:

$ t = (frac(1, 4. 9))^(1 \/ 2) x^(1 \/ 2) $
...
#image("files/Fig4_9-8f27794715ecea47dfa7fe49f3436426.png", width: 90%)
...
$ t = 0. 4515 times x^(1 \/ 2) $
Which follows the form:

$ "vertical variable" = "slope"times "horizontal variable" $
Where:
...
#image("files/Fig4_10-6b0e59d8e70c39653a09bcd6acd82140.png", width: 90%)
...
#image("files/Fig4_11-73505d0ecee635c4d8d409694f71d16f.png", width: 90%)
