...
Conclude your introduction by summarizing your specific experimental goals. For example: "Thus, by measuring refractive index variation with wavelength, we can test Cauchy's model using n versus 1/$lambda$² graphical analysis. The Cauchy coefficients A and B for our glass specimen will be determined from the graph's intercept and slope, respectively." This summary provides readers with a framework for understanding the experimental procedure that follows, particularly valuable in complex reports with extended introductions.
...
#image("files/free_fall_apparatus-bb8ee9123d8e9a972d81bd97917c95e5.png", width: 90%)
...
#image("files/Fig7_2-0c057183422b333cf26d80fd4a4831f0.png", width: 90%)
